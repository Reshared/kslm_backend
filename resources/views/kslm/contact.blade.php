...
@section('js')
    ...
    <script>
        var map = new AMap.Map('map', {
            resizeEnable: true,
            center: [{{ $settings['contact']['经度'] }}, {{ $settings['contact']['纬度'] }}],//[116.314955, 39.675723],
            zoom: 16
        });
            ...
            <div class="container">
                <div class="line">
                    ...
                    <div class="loc-describe">
                        <div class="company">
                            <h4 class="co-000">{{ $settings['contact']['公司名称'] }}</h4>
                            <div class="text co-666 font-16">{{ $settings['contact']['简介'] }}</div>
                        </div>
                        <ul class="list">
                            <li>
                                <img src="./images/icon-server.png" alt="">
                                <span>统一服务热线：</span>{{ $settings['contact']['统一服务热线'] }}
                            </li>
                            <li>
                                <img src="./images/icon-building.png" alt="">
                                <span>北京代表处：</span>{{ $settings['contact']['北京代表处'] }}
                            </li>
                            <li>
                                <img src="./images/icon-email.png" alt="">
                                <span>邮箱：</span>{{ $settings['contact']['邮箱'] }}
                            </li>
                            <li>
                                <img src="./images/icon-location.png" alt="">
                                <span>地址：{{ $settings['contact']['地址'] }}</span>
                            </li>
                        </ul>
                    </div>
                </div>

<div class="modal fade" tabindex="-1" role="dialog" id="olMessageModal">
            ...
            <div class="modal-body">
                ...
                <div class="form-container">
                    <form class="form-horizontal" id="olForm">
                        ...
                        <div class="form-group">
                            <label for="formProduct" class="col-sm-3"><span
                                        class="co-red">*</span><span>感兴趣的产品</span>&nbsp;&nbsp;:&nbsp;&nbsp;</label>
                            <div class="col-sm-9">
                                <ul id="formProduct" class="checkbox-list clear">
                                    <li><i></i><span>超滤膜</span></li>
                                    <li><i></i><span>纳滤膜</span></li>
                                    <li><i></i><span>微滤膜</span></li>
                                    <li><i></i><span>反渗透膜</span></li>
                        ...
                        <div class="form-group">
                            <label for="formAppArea" class="col-sm-3"><span
                                        class="co-red">*</span><span>应用领域</span>&nbsp;&nbsp;:&nbsp;&nbsp;</label>
                            <div class="col-sm-9">
                                <ul id="formAppArea" class="checkbox-list clear">
                                    <li><i></i><span>医药行业</span></li>
                                    <li><i></i><span>生物行业</span></li>
                                    <li><i></i><span>一般工业</span></li>
                                    <li><i></i><span>水处理行业</span></li>
                                    <li><i></i><span>食品与饮料行业</span></li>
